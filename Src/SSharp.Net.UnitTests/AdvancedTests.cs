...
namespace UnitTests
{
  ...
  public class AdvancedTests : IDisposable
  {
    ...
    public void WorkingWithDataSets()
    {
      ...
      Assert.Equal(data.Tables["table1"].Rows[0][1], result);

      result = Script.RunCode(@"
            data.Tables['table1'].Rows[0][1] = 'Maria';
           ", context);

      Assert.Equal("Maria", data.Tables["table1"].Rows[0][1]);
    ...
    public void FunctionRecursionWithLocalAssignment()
    {
      ...
      object result = script.Execute();
      Assert.Equal((int)Math.Pow(2,n), (int)result);
    }
    ...
    public void Graphs()
    {
      ...
      Assert.Equal("1->2, 2->3, 1->4, 1->5, ", result);
    }
    ...
    public void MethodHandling()
    {
      ...
      Assert.Equal(Math.Sin(0.75), result);
    }
    ...
    {
      //TODO: This used to work in .NET 4
      object result = Script.RunCode(@"
             a = new TestInterface();
    ...
    public void CallToGenericMethod()
    {
      ...
      Assert.Equal(new TestInterface().GenericGet<string>("Hello World"), result);
    }
    ...
    public void UsingGenericArguments()
    {
      ...
      Assert.IsType<TestInterface>(result);
    }
    ...
    public void AccessingShadowedMembers()
    {
      ...
      Assert.Equal("BaseShadowBaseGetShadowGet", result);
    }
    ...
    public void AccessingExtensionMethods1() {
        ...
        Assert.Equal(input.OfType<int>().Count(), result);
    }
    ...
    public void AccessingExtensionMethodsWithLambdaExpressions() {
        ...
        Assert.Equal(input.OfType<int>().Select(i => i > 3).Count(), result.Context.Result);
        ...
        Assert.Equal(input.OfType<int>().Where<int>(i => i > 3).ToArray().Length, result.Context.Result);
    }
    ...
    public void AccessingExtensionMethodsWithLambdaExpressionsEx() {
        ...
        Assert.Equal(input.OfType<int>().Sum(x=>x*x), result.Context.Result);
    }
